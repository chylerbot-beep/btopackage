...
export async function POST(request: Request) {
  ...
  const payload = {
    ...
    master_wardrobe_full_height: Boolean(body.master_wardrobe_full_height),
    ...
    common_wardrobe_room2_full_height: Boolean(body.common_wardrobe_room2_full_height),
    ...
    common_wardrobe_room3_full_height: Boolean(body.common_wardrobe_room3_full_height),
    ...
    verification_expiry_date: body.verification_expiry_date || null,
