...
export async function POST(request: Request) {
  ...
  const payload = {
    ...
    description_carpentry: trimToNull(body.description_carpentry),
    description_finishes: trimToNull(body.description_finishes),
    description_works: trimToNull(body.description_works),
    description_service: trimToNull(body.description_service),
