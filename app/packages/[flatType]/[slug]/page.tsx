...
export default async function PackagePage({ params }: PackagePageProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl">
      ...
      {hasIncludedContent ? (
        <div className="mt-6 mb-0">
          <h2 className="mb-3 mt-6 px-4 text-base font-semibold text-[#1A1A1A]">
      ...
      <div className="mt-6 mb-0">
        <h2 className="mb-3 mt-6 px-4 text-base font-semibold text-[#1A1A1A]">Not covered by this package</h2>
      ...
      <div className="mt-6 mb-0">
        {freebiesItems.length > 0 ? (
          <div className="mx-4 mb-0 rounded-xl border border-[#FDE68A] bg-[#FFFBEB] p-4">
